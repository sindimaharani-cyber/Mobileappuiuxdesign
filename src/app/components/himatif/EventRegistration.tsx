  ...
  return (
    <div className="pb-20 bg-[#F4F6F8]">
      <div className="px-4 pt-4">
        {/* Header */}
        <div className="mb-6">
          <h2 className="text-xl font-bold text-[#0A1D37]">Pendaftaran & Absensi</h2>
          <p className="text-sm text-gray-600">Event dan kehadiran kegiatan</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <Card className="p-4 border-0 shadow-sm bg-white">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-gray-600">Event Terdaftar</p>
        ...
        {/* Available Events */}
        <div className="mb-6">
          <h3 className="font-semibold text-[#0A1D37] mb-3">Event Tersedia</h3>
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            <h3 className="font-semibold text-[#0A1D37]">Riwayat Kehadiran</h3>
            ...
            {myAttendance.map((attendance, index) => (
              <Card key={index} className="p-4 border-0 shadow-sm bg-white">
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <h4 className="font-medium text-[#0A1D37] mb-1">
        ...
        <Dialog open={showQR} onOpenChange={setShowQR}>
          <DialogContent className="max-w-sm">
            ...
            <div className="py-6">
              <div className="w-64 h-64 mx-auto bg-white border-4 border-[#1565C0] rounded-lg p-4 flex items-center justify-center">
                <div className="text-center">
                  <QrCode className="w-48 h-48 text-[#0A1D37]" />
                </div>
              </div>
              <div className="mt-4 text-center">
                <p className="font-semibold text-[#0A1D37] mb-1">{userName}</p>
                <p className="text-sm text-gray-600">Scan untuk absensi</p>
              </div>
            </div>
          </DialogContent>
        </Dialog>
