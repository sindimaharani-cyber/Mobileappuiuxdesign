    ...
    <div className="pb-24">
      <div className="px-4 pt-4">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-xl font-bold text-foreground">Dokumentasi & Arsip</h2>
            <p className="text-sm text-muted-foreground">Repository dokumen HIMATIF</p>
          </div>
          {canManage && (
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 bg-background">
              ...
              <div className="flex items-center gap-2 text-xs text-muted-foreground">
                <div className="flex-1 bg-background bg-muted rounded-full h-2">
        ...
        <Tabs defaultValue="all" className="space-y-4">
          ...
          <TabsContent value="all" className="space-y-3 mt-4">
            {allDocuments.map((doc) => (
              <Card key={doc.id} className="p-4 border-0 bg-card">
                <div className="flex gap-3">
                  ...
                  <div className="flex-1 bg-background min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-1">
                      ...
                      <Badge className="text-xs bg-muted text-gray-700 flex-shrink-0">
          ...
          <TabsContent value="lpj" className="space-y-3 mt-4">
            ...
            {documentsByType('lpj').length === 0 && (
              <Card className="p-8 text-center bg-card">
                <p className="text-muted-foreground">Tidak ada dokumen LPJ</p>
              </Card>
            )}
          </TabsContent>
          ...
          <TabsContent value="proposal" className="space-y-3 mt-4">
            ...
            {documentsByType('proposal').length === 0 && (
              <Card className="p-8 text-center bg-card">
                <p className="text-muted-foreground">Tidak ada proposal</p>
              </Card>
            )}
          </TabsContent>
          ...
          <TabsContent value="notulen" className="space-y-3 mt-4">
            ...
            {documentsByType('notulen').length === 0 && (
              <Card className="p-8 text-center bg-card">
                <p className="text-muted-foreground">Tidak ada notulen</p>
              </Card>
            )}
          </TabsContent>
        </Tabs>
